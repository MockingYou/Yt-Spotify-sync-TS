...
const PlaylistSelector = ({ source, destination, playlistLink, setPlaylistLink }) => {
  ...
  return (
    <Fragment>
      <div className="flex h-screen flex-col items-center justify-center bg-gray-900">
        ...
        <Playlists source={persistedSource} destination={destination} playlistLink={playlistLink} setPlaylistLink={setPlaylistLink} />
      </div>
    </Fragment>
  );
};
