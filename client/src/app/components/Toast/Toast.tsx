...
import { CheckCircleIcon, InformationCircleIcon, XMarkIcon as XMarkIcon } from '@heroicons/react/24/solid';
                            ...
                            <div className="p-4">
                                <div className="flex items-start">
                                    <div className="flex-shrink-0">
                                        ...
                                        {type === 'error' && <XMarkIcon className="h-6 w-6 text-red-400" aria-hidden="true" />}
                                        {type === 'info' && (
